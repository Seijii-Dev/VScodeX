...
import io.vscodex.net.core.Secrets
...
object Gemini {
    ...
    suspend fun chat(prompt: String): Result<GenerateContentResponse> {
    ...
    suspend fun rewriteCode(code: String, instruction: String): Result<GenerateContentResponse> {
        return generateContent("Rewrite the following code based on this instruction: $instruction\n\nCode:\n$code\n\nReturn ONLY the rewritten code, no explanation.")
    }
