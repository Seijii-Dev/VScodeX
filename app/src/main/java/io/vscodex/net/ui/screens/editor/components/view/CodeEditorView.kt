package io.vscodex.net.ui.screens.editor.components.view
...
import io.vscodex.net.editor.databinding.LayoutCodeEditorBinding
import io.vscodex.net.editor.language.textmate.VSXTMLanguage
import io.vscodex.net.events.OnPreferenceChangeEvent
import io.vscodex.net.file.File
import io.vscodex.net.file.extension
import io.vscodex.net.preferences.PREF_APPEARANCE_UI_MODE_KEY
import io.vscodex.net.preferences.PREF_EDITOR_COLORSCHEME_KEY
import io.vscodex.net.preferences.PREF_EDITOR_DELETELINEONBACKSPACE_KEY
import io.vscodex.net.preferences.PREF_EDITOR_DELETETABONBACKSPACE_KEY
import io.vscodex.net.preferences.PREF_EDITOR_FONTLIGATURES_KEY
import io.vscodex.net.preferences.PREF_EDITOR_FONT_KEY
import io.vscodex.net.preferences.PREF_EDITOR_FONT_SIZE_KEY
import io.vscodex.net.preferences.PREF_EDITOR_INDENT_KEY
import io.vscodex.net.preferences.PREF_EDITOR_LINENUMBER_KEY
import io.vscodex.net.preferences.PREF_EDITOR_STICKYSCROLL_KEY
import io.vscodex.net.preferences.PREF_EDITOR_USETAB_KEY
import io.vscodex.net.preferences.PREF_EDITOR_WORDWRAP_KEY
import io.vscodex.net.preferences.editorColorScheme
import io.vscodex.net.preferences.editorDeleteLineOnBackspace
import io.vscodex.net.preferences.editorDeleteTabOnBackspace
import io.vscodex.net.preferences.editorFont
import io.vscodex.net.preferences.editorFontLigatures
import io.vscodex.net.preferences.editorFontSize
import io.vscodex.net.preferences.editorIndent
import io.vscodex.net.preferences.editorLineNumber
import io.vscodex.net.preferences.editorStickyScroll
import io.vscodex.net.preferences.editorUseTab
import io.vscodex.net.preferences.editorWordWrap
import io.vscodex.net.providers.GrammarProvider
import io.vscodex.net.resources.R
import io.vscodex.net.utils.cancelIfActive
