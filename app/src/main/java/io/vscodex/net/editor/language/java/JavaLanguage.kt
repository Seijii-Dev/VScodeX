...
package io.vscodex.net.editor.language.java

import android.os.Bundle
import androidx.compose.ui.util.fastForEach
import io.vscodex.net.editor.completion.SimpleSnippetCompletionItem
import io.vscodex.net.editor.snippet.SnippetController
