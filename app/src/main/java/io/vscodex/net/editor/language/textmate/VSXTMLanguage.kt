 ...
 */
package io.vscodex.net.editor.language.textmate
...
class VSXTMLanguage protected constructor(
    ...
    override fun getSymbolPairs(): VSXTMSymbolPairMatch {
        return symbolPairMatch
    }

    override fun getNewlineHandlers(): Array<VSXTMNewlineHandler> {
